<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ArtFavorito.aspx.cs" Inherits="Trabajo_Final_N_3_Gonzalez_Nicolas.ArtFavorito" %>
                        ...
                        <div class="card-group">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:Button Text="❌" runat="server" CssClass="btn btn-outline-warning"
                                        CommandName="Id" CommandArgument='<%#Eval("Id")%>' OnClick="BtnEliminarFav_Click"
                                        ID="BtnEliminarFav" /> 
